 ...
 * Replaces duplicate ModEvents.java and ModularFurnaceConnectivityHandler.java logic.
 */
...
public class ModularFurnaceCommonEvents {
     ...
     * This isolates all connected furnace blocks and attempts to reform valid structures.
     */
